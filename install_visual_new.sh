...
#echo ">>> Install a prebuilt Detectron2 wheel matching torch 2.2 + cu118"
#pip install -f https://dl.fbaipublicfiles.com/detectron2/wheels/cu118/torch2.2/index.html \
#  "detectron2==0.6"
...
echo ">>> Confirm we have detectron2: "
python - <<'PY'
